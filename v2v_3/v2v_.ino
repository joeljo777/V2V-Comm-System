...
/**
 * @brief  Initialise GPS UART1 on GPIO 35 and wait briefly for first characters.
 * @return true if GPS appears to be transmitting.
 */
bool initGPS() {
    Serial.print("[INIT] Initialising GPS UART1 (GPIO 35)... ");
    ...
    if (gotChar) {
        Serial.printf("OK  [UART1 RX=GPIO%d, %d baud]\n", GPS_RX_PIN, GPS_BAUD);
    } else {
